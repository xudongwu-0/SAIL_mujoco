...
class Workspace(object):
    ...
    def evaluate(self):
        ...
        for episode in range(self.cfg.num_eval_episodes):
            obs = self.env.reset()
            # self.agent.reset()  <- This function was not fully implemented, commenting out for safety
            done = False
            episode_reward = 0
    ...
    def run(self):
        ...
        while self.step < self.cfg.num_train_steps:
            ...
            if self.step == (self.cfg.num_seed_steps + self.cfg.num_unsup_steps):
                ...
                self.agent.update(self.replay_buffer, self.logger, self.step, self.cfg.gradient_update) # Using gradient_update from cfg
...
@hydra.main(config_path='config/train_V.yaml', strict=True)
def main(cfg):
