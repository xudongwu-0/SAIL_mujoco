...
do
  echo "--------------------------------------------------"
  echo ">>> [PEBBLE] walker_walk | Seed: $SEED"
  echo "--------------------------------------------------"

  CUDA_VISIBLE_DEVICES=0 python train_PEBBLE.py \
    env=walker_walk \
    seed=$SEED \
    experiment=PEBBLE_walker_walk_400k_seed${SEED} \
  ...
  echo "=================================================="
  echo ">>> [TRPO ablation] walker_walk | Seed: $SEED"
  echo "=================================================="
  CUDA_VISIBLE_DEVICES=0 python train_V_npg.py \
    env=walker_walk \
    seed=$SEED \
    experiment=TRPO_abl_walker_walk_400k_seed${SEED} \
    agent.params.actor_lr=0.0005 \
    agent.params.critic_lr=0.0005 \
    agent.params.batch_size=512 \
    num_unsup_steps=900 \
  ...
  echo "=================================================="
  echo ">>> [TRPO] walker_walk | Seed: $SEED"
  echo "===========================max_kl======================="
  CUDA_VISIBLE_DEVICES=0 python train_V_npg.py \
    env=walker_walk d\
    seed=$SEED \
    experiment=TRPO_walker_walk_400k_seed${SEED} \
    agent.params.actor_lr=0.0005 \
    agent.params.critic_lr=0.0005 \
    agent.params.batch_size=512 \
    num_unsup_steps=900 \
  ...
  echo "=================================================="
  echo ">>> [SGD] walker_walk | Seed: $SEED"
  echo "=================================================="
  CUDA_VISIBLE_DEVICES=0 python train_V.py \
    env=walker_walk \
    seed=$SEED \
    experiment=SGD_baseline_walker_walk_400k_seed${SEED} \
    agent.params.actor_lr=0.0005 \
    agent.params.critic_lr=0.0005 \
    agent.params.batch_size=512 \
    num_unsup_steps=900 \
